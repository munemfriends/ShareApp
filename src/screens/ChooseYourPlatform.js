...
function ChooseYourPlatform ({navigation}) {
        ...
        <ScrollView>
                        ...
                        <View style={styles.modalBody}>
                            ...
                            <View  style={styles.formCont} >
                                ...
                                <View style={styles.btnContainer}>
                                    <Button
                                        onPress={()=> navigation.navigate('social_profile')}
                                        medium
                                        square
                                        block
            ...
            <View style={styles.containerView}>
                ...
                <Animatable.View delay={1000} animation="fadeInLeft" iterationCount={1}>
                    ...
                    {/* <Text style={styles.totalSpendText}>Instagram</Text> */}
                </Animatable.View>
...
export default ChooseYourPlatform;